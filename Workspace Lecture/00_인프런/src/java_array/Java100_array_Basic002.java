package java_array;
// 배열과 인덱스의 관계애 대해서 설명하고 배열의 초깃값은 어떻게 셋팅되는지.
// 크기 10의 정수형 배열을 생성하고 인덱스로 배열 공값의 값 출력하기
// 이 문제는 자바의 배열 및 인덱스 사용법 그리고 배열 생성시 초깃값이 어떻게 정해지는지를 묻는 문제.
...
// ex) 배열 변수는 보물 위치가 저장되어 있는 핸드폰과 같다.
...
public class Java100_array_Basic002 {
	public static void main(String[]args) {
		...
		int s_size=scores.length;	// 배열 변수의 크기를 s_size에 저장
		...
		// System.out.println(scores[10]); // error(인덱스 범위 벗어났기 때문에)
