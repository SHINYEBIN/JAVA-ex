...
// switch 조건문의 사용법
// 사용자가 자신의 연령대를 입력하면 해당 연령대에 맞는 책을 추천하는 코드 만들기
// 이 문제는 자바의 switch 조건문을 사용할 수 있는지에 대한 문제
...
public class Java100_switch_Basic001 {
	public static void main(String[] args) {
		...
		case 10 : 
			...
			break;
		case 20 : 
			System.out.println(age+"대 입니다. 취업 서적 코너는 C 구역입니다.");
			break;
		case 30 : 
			System.out.println(age+"대 입니다. 자기 계발 코너는 E 구역입니다.");
			break;
		case 40 : 
			System.out.println(age+"대 입니다. 재테크 코너는 B 구역입니다.");
			break;
		case 50 : 
			System.out.println(age+"대 입니다. 재취업 코너는 E 구역입니다.");
			break;
		default : 
			System.out.println("60대 이상입니다. 건강/장수 코너는 E 구역입니다.");
		}
